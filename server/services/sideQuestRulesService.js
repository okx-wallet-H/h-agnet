...
const defaultSideQuestRules = [
  {
    ...
    title: '卡库启航',
    description: '卡库累计 1 张有效卡片，解锁成长系统入口。',
  ...
  },
  {
    id: 'trade-master',
    title: '交易达人',
    description: '交易类卡片累计 5 张，解锁交易达人称号。',
    category: 'trading',
    rewardLabel: '交易达人',
  ...
  },
  {
    id: 'wallet-operator',
    title: '钱包指挥官',
    description: '钱包动作卡累计 3 张，证明你熟悉充值、提现或转账流程。',
    category: 'wallet',
    rewardLabel: '钱包指挥官',
    metricPath: 'activity.walletActions',
    target: 3,
    unit: '张',
    enabled: true,
    sortOrder: 30,
  },
  {
    id: 'receipt-watcher',
    title: '回执观察员',
    description: '执行回执累计 1 张，理解授权与真实广播之间的区别。',
    category: 'execution',
    rewardLabel: '回执观察员',
  ...
  },
  {
    ...
    title: '支线开拓者',
    description: '支线任务卡累计 3 张，开始建立社区成长记录。',
    category: 'boost',
    rewardLabel: '支线开拓者',
  ...
  },
  {
    id: 'portfolio-scout',
    title: '资产观察员',
    description: '资产分析卡累计 3 张，解锁更细的组合建议依据。',
    category: 'portfolio',
    rewardLabel: '资产观察员',
  ...
  },
  {
    id: 'verified-record',
    title: '真实战绩',
    description: '已验证结果累计 1 张。只有后端验证过的真实结果才会计入。',
